...
class Slot(Base):
    ...
    __table_args__ = (UniqueConstraint("uuid_teacher", "dt_start", name="_teacher_dt_start_uc"),)
    
    teacher: Mapped["User"] = relationship(argument="User", foreign_keys=[uuid_teacher], back_populates="teacher_slots")
    student: Mapped["User"] = relationship(argument="User", foreign_keys=[uuid_student], back_populates="student_slots")
